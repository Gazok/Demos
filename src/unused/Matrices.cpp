...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::translate(const Vector3f& v)
{
...
{ 
    ...
    return Matrix4( 
            2.f*n/w, 0.f,     2.f*(r+l)/w,   0.f,
            0.f,     2.f*n/h, 2.f*(t+b)/h,   0.f,
...
// gluPerspective
// /////////////////////////////////////////////
Matrix4 Matrix4::frustum(float fov, float aspect, float near, float far)
{
    const float delta  = tan(fov/2 * DEG2RAD);
    const float height = delta * near;
