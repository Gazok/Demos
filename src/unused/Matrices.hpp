...
public:
    ...
    void        setRow(int index, const Vector2f& v);
    void        setColumn(int index, const float col[2]);
    void        setColumn(int index, const Vector2f& v);
    ...
    Vector2f     operator*(const Vector2f& rhs) const;    // multiplication: v' = M * v
    ...
    friend Vector2f operator*(const Vector2f& vec, const Matrix2& m); // pre-multiplication
...
public:
    ...
    friend Vector3f operator*(const Vector3f& vec, const Matrix3& m); // pre-multiplication
...
public:
    //{{{static members
    static Matrix4 frustum(float fov, float aspect, float near, float far);
    ...
    Matrix4&    translate(const Vector3f& v);            //
    Matrix4&    rotate(float angle, const Vector3f& axis); // rotate angle(degree) along the given axix
    ...
    friend Vector3f operator*(const Vector3f& vec, const Matrix4& m); // pre-multiplication
    friend Vector4f operator*(const Vector4f& vec, const Matrix4& m); // pre-multiplication
...
inline void Matrix2::setRow(int index, const Vector2f& v)
{
...
inline void Matrix2::setColumn(int index, const Vector2f& v)
{
...
inline Vector2f Matrix2::operator*(const Vector2f& rhs) const
{
    return {m[0]*rhs.x + m[1]*rhs.y,  m[2]*rhs.x + m[3]*rhs.y};
}
...
inline Vector2f operator*(const Vector2f& v, const Matrix2& rhs)
{
    return {v.x*rhs[0] + v.y*rhs[2],  v.x*rhs[1] + v.y*rhs[3]};
}
...
inline void Matrix3::setRow(int index, const Vector3f& v)
{
...
inline void Matrix3::setColumn(int index, const Vector3f& v)
{
...
inline Vector3f Matrix3::operator*(const Vector3f& rhs) const
{
...
inline Vector3f operator*(const Vector3f& v, const Matrix3& m)
{
    return {v.x*m[0] + v.y*m[3] + v.z*m[6],  v.x*m[1] + v.y*m[4] + v.z*m[7],  v.x*m[2] + v.y*m[5] + v.z*m[8]};
}
...
inline void Matrix4::setRow(int index, const Vector4f& v)
{
...
inline void Matrix4::setRow(int index, const Vector3f& v)
{
...
inline void Matrix4::setColumn(int index, const Vector4f& v)
{
...
inline void Matrix4::setColumn(int index, const Vector3f& v)
{
...
inline Vector4f Matrix4::operator*(const Vector4f& rhs) const
{
...
inline Vector3f Matrix4::operator*(const Vector3f& rhs) const
{
    return {m[0]*rhs.x + m[1]*rhs.y + m[2]*rhs.z,
...
inline Vector4f operator*(const Vector4f& v, const Matrix4& m)
{
    return {v.x*m[0] + v.y*m[4] + v.z*m[8] + v.w*m[12],  v.x*m[1] + v.y*m[5] + v.z*m[9] + v.w*m[13],  v.x*m[2] + v.y*m[6] + v.z*m[10] + v.w*m[14], v.x*m[3] + v.y*m[7] + v.z*m[11] + v.w*m[15]};
}
